/* 
1. 일반 속성 관계
2.  SQL 문장에서 집합별로 집계된 데이터에 대한 조회 조건을 제한하기 위해서 사용하는 절은 HAVING절
...
/* 14 총무팀에 근무하는 직원의 이름, 주소, 부서명을 볼 수 있는 뷰 작성 */
...
SELECT LAST_NAME, SALARY, TO_CHAR((SALARY/1000), '$99,999.9') AS THOUSANDS
FROM EMPLOYEES;
...
--1
 SELECT E.LAST_NAME, M.LAST_NAME MANAGER, M.SALARY, G.GRADE_LEVEL AS GRA
 ...
 --2
 SELECT E.LAST_NAME, M.LAST_NAME MANAGER, M.SALARY, G.GRADE_LEVEL AS GRA
 FROM EMPLOYEES E, EMPLOYEES M, JOB_GRADES G
