...
SELECT MENU_NO
    ,  SUM(DECODE(TO_CHAR(MENU_LOG_TIME, 'DD'), '1', 1, 0)) "1"
    ,  SUM(DECODE(TO_CHAR(MENU_LOG_TIME, 'DD'), '2', 1, 0)) "2"
    ,  SUM(DECODE(TO_CHAR(MENU_LOG_TIME, 'DD'), '3', 1, 0)) "3"
    ,  SUM(DECODE(TO_CHAR(MENU_LOG_TIME, 'DD'), '4', 1, 0)) "4"
    ,  SUM(DECODE(TO_CHAR(MENU_LOG_TIME, 'DD'), '5', 1, 0)) "5"
    ,  SUM(DECODE(TO_CHAR(MENU_LOG_TIME, 'DD'), '6', 1, 0)) "6"
    ,  SUM(DECODE(TO_CHAR(MENU_LOG_TIME, 'DD'), '7', 1, 0)) "7"
    ,  SUM(DECODE(TO_CHAR(MENU_LOG_TIME, 'DD'), '8', 1, 0)) "8"
    ,  SUM(DECODE(TO_CHAR(MENU_LOG_TIME, 'DD'), '9', 1, 0)) "9"
